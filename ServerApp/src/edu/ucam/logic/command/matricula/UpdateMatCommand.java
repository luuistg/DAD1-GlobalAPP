...
public class UpdateMatCommand implements ICommand{
	...
	public String execute(CommandParser cp, ClientHandler cl) {
		try {
			...
			Consumer<Matricula> action = (t) -> dao.actualizar(t);
			
			ReciveStrategy<Matricula> strategy = new ReciveStrategy<>(action);
			...
			return new ProtocolResponse(
		   	        ...
		   	        cp.getId(), 
		   	        404, 
		   	        "NO existe la Matricula con ese id"
						).toProtocolString();
		}
