...
public class UpdateAsigCommand implements ICommand{
	...
	public String execute(CommandParser cp, ClientHandler cl) {
		try {
			...
			Consumer<Asignatura> action = (t) -> dao.actualizar(t);
			
			ReciveStrategy<Asignatura> strategy = new ReciveStrategy<>(action);
			...
			return new ProtocolResponse(
		   	        ...
		   	        cp.getId(), 
		   	        404, 
		   	        "NO existe la Asignatura con ese id"
						).toProtocolString();
		}
